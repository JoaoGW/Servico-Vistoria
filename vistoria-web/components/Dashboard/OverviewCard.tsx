...
export default function OverviewCard({ description, label, tone, value }: OverviewCardProps) {
  return (
    <section className="rounded-2xl border border-[#DDE3ED] bg-white px-5 py-5 shadow-[0_8px_24px_rgba(30,39,74,0.06)] sm:px-6">
      ...
      <p className={`mt-3 text-4xl font-bold tracking-tight ${toneClasses[tone]}`}>{value}</p>
