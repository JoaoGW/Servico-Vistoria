    ...
    <ScrollView
      ...
      <Box className="flex-1 pb-8">
        <Box className="border-b border-vistoria-borda bg-vistoria-superficie px-6 pb-6 pt-5">
          ...
          <Text className="mt-2 text-[30px] font-bold text-vistoria-titulo">Peacore Vistorias</Text>
        ...
        <Box className="flex-row items-end justify-between bg-vistoria-superficie px-6 py-8">
          <Text className="text-[64px] font-bold leading-none text-vistoria-marca">{horarioAtual}</Text>
          <Box className="ml-4 items-end pb-1">
            <Text className="text-lg font-bold text-vistoria-marca">{dataAtual}</Text>
        ...
        {possuiVistoriaAtiva ? (
          <Box className="mx-6 mt-6 rounded-xl border border-vistoria-borda bg-vistoria-superficie p-5">
            <Text className="text-xl font-bold text-vistoria-titulo">Resumo da vistoria</Text>
