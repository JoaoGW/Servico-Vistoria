...
export function AvisoSemRegistros({ icone, mensagem }: IAvisoSemRegistrosProps) {
  return (
    <Box
      ...
      <Text className="flex-1 text-base leading-6 text-vistoria-auxiliar">{mensagem}</Text>
    </Box>
  )
}
